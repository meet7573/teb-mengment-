...
import { Users, Plus, Tablet, CheckCircle2, XCircle, Edit3 } from 'lucide-react';
...
type ExtendedStudent = Student & { roomNumber?: string; wingNumber?: string; appPin?: string };

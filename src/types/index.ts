...
export interface Student { id: string; name: string; pinNumber: string; standard: StandardGrade; isCoachingStudent: boolean; status: 'Active' | 'Inactive'; assignedTabletId?: string; assignedTabletNumber?: string; photoPath?: string; createdAt: string; }
